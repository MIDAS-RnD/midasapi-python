...
`ID`: Element ID  
`TYPE`: Element type = <font color="red">'TENSTR'</font>  
...
### Tension Element
**<font color="green">`Element.Tension(i:int, j:int, stype:int, mat = 1, sect = 1, angle = 0, id = 0, non_len = None, cable_type = None, tens = None, t_limit = None)`</font>**  
...
### Compression Element
**<font color="green">`Element.Compression(i:int, j:int, stype:int, mat = 1, sect = 1, angle = 0, id = 0, tens = None, t_limit = None, non_len = None)`</font>**  
