...
### <font style="font-size:0px">Element.</font>clear
Deletes all element data from both Python.
...
### 1. Truss
**<font color="green">`Element.Truss(i:int, j:int, mat = 1, sect = 1, angle = 0, id=None)`</font>**  
...
### 1. Beam
**<font color="green">`Element.Beam(i:int, j:int, mat = 1, sect = 1, angle = 0, id=None)`</font>**  
...
### Constructor
**<font color="green">`Element.Plate(nodes:list, stype:int=1, mat = 1, sect = 1, angle = 0, id=None)`</font>**  
